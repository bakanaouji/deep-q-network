...
def main():
    ...
    params['replay_memory_size'] = 1000  # SGDによる更新に用いるデータは，このサイズの直近のフレームデータからサンプルする
    ...
    params['save_network_path'] = 'saved_networks/' + params['env_name'] +  '_without_replay_memory_1000/model.ckpt'
    params['save_summary_path'] = 'summary/' + params['env_name'] + '_without_replay_memory_1000'
