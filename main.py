...
def main():
    ...
    params['final_exploration_frame'] = 1000  # εが初期値から最終値に線形減少した時に，最終値に到達するフレーム数
    params['final_exploration'] = 0.01  # ε-greedyにおけるεの最終値
    params['learn_frequency'] = 4   # この行動回数ごとに学習
    params['replay_start_size'] = 100  # 学習を始める前に，このフレーム数に対して一様ランダムに行動を選択する政策が実行され，その経験がReplay memoryに蓄えられる
